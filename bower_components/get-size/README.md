...
[Firefox has an old bug](https://bugzilla.mozilla.org/show_bug.cgi?_id=548397) that occurs within iframes that are hidden with `display: none`. To resolve this, you can use alternate CSS to hide the iframe off-screen, with out `display: none`.
